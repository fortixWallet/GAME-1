...
const FACTS := {
	&"f.mark_maker":      {"shown_in": "frame:mark_maker_macro", "cite": "the maker's shield on the foot", "tag": &"marks", "weight": 1,
	...
	&"f.mark_diana":      {"shown_in": "frame:mark_diana_macro", "cite": "the letter set inside the head", "tag": &"marks", "weight": 2,
	...
	&"f.marks_alone":     {"shown_in": "derived", "cite": "no earlier assay punch on the piece", "tag": &"marks", "weight": 2,
		"text": "The rest of the underside is bare. No third punch, no figures, no bright patch where one had been taken off."},
	&"f.reg_hoffmann":    {"shown_in": "paper", "cite": "the register: Hoffmann, 1859 to 1871", "tag": &"books", "weight": 2,
		"text": "Register of Vienna workshops: HOFFMANN, Leopold — silversmith. Mark entered 1859. Mark struck out 1871."},
	&"f.hb_vienna_marks": {"shown_in": "paper", "cite": "the handbook of Vienna marks", "tag": &"books", "weight": 2,
	...
	&"f.domes":           {"shown_in": "frame:goblet_domes_macro", "cite": "two domes on the top of the foot", "tag": &"body", "weight": 2,
		"text": "Two small domes stand up on the slope of the foot, one behind each punch."},
	&"f.domes_alike":     {"shown_in": "frame:goblet_domes_macro", "cite": "both domes alike, to the shoulder", "tag": &"body", "weight": 3,
		"text": "Both domes rise to the same height and break at the same sharp shoulder."},
	&"f.foot_edge_plain": {"shown_in": "model:goblet", "cite": "the foot band bears no lettering", "tag": &"body", "weight": 1,
	...
	&"f.bowl_gilt":       {"shown_in": "model:goblet", "cite": "the bowl is gilt inside", "tag": &"body", "weight": 1,
		"text": "The inside of the bowl is gilded. The gilding is thin in a crescent under one side of the lip."},
	&"f.knop_form":       {"shown_in": "model:goblet", "cite": "a knop on the stem", "tag": &"body", "weight": 1,
		"text": "The stem swells into a knop the size of a walnut, cast in two shells and soldered round the girdle."},
	&"f.height_196":      {"shown_in": "measured", "cite": "196 mm on the caliper", "tag": &"measure", "weight": 1,
		"text": "Height, lip to table: 196 mm. Foot: 104 mm across."},
	&"f.weight_331":      {"shown_in": "measured", "cite": "331 g on the balance", "tag": &"measure", "weight": 1,
		"text": "On the balance: 331 g."},
	&"f.receipt_1807":    {"shown_in": "paper", "cite": "the re-marking receipt of 1807", "tag": &"papers", "weight": 1,
	...
	&"f.receipt_mismatch":{"shown_in": "paper", "cite": "the receipt is 219 mm, the cup is 196", "tag": &"papers", "weight": 2,
	...
	&"f.letter_read":     {"shown_in": "paper", "cite": "the client's own letter", "tag": &"papers", "weight": 1,
		"text": "She writes: from an aunt in the monastery, and she is told it is Viennese."},
	&"f.news_robbery":    {"shown_in": "paper", "cite": "the Herald of 14 March on the sacristy", "tag": &"papers", "weight": 1,
		"text": "St. Onuphrius' sacristy, broken into. Among the missing: antique silver goblets."},
	&"f.church_mark":     {"shown_in": "frame:goblet_church_macro", "cite": "the effaced church mark beneath", "tag": &"marks", "weight": 3,
