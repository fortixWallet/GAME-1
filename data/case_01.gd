...
#
# ⚠⚠ УВАГА: ЦЕЙ ФАЙЛ ОПИСУЄ ЗАДУМАНУ СПРАВУ, А НЕ ТУ, ЩО ЗАРАЗ У ГРІ. ⚠⚠
#
...
#
#   ЩО В СПЕЦИФІКАЦІЇ (case_01.md), і чого в арті НЕМА:
...
#
# НАСЛІДОК: центральна дедукція справи 1 гравцеві фізично недоступна — дивитися
# нема на що. Поки арт не домальовано, рядки `say` нижче ПІДКЛЮЧАТИ НЕ МОЖНА:
# гра описуватиме клейма, яких немає в кадрі (PLAYBOOK §4.5).
#
# Підключено з цього файлу поки що ТІЛЬКИ геометрію зони z.foot.underside.
#
