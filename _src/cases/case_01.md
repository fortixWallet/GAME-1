...
> ## ⚠ 26.07: АРТ РЕАЛІЗУЄ ІНШУ ЗАГАДКУ, НІЖ ЦЕЙ ДОКУМЕНТ
>
...
>
> **Але голови Діани з цифрою 3 і літерою A всередині контуру в арті НЕМА.** А саме на ній
...
>
> **Розвилка, і вона за Віктором:**
> 1. **Домалювати клейма** під цей документ (два пунсони: прямокутник зі зрізаними кутами
>    L·HOFFMANN + голова Діани з цифрою і літерою всередині контуру). Тоді справа 1 отримує
>    свій стрибок думки, а зішліфована пляма лишається другим шаром.
> 2. **Переписати документ під наявний арт** — і тоді визнати, що справа 1 туторіал без
>    стрибка, а перша справжня дедукція починається зі справи 2.
>
> Я рекомендую (1): без неї справа 1 не детектив, а огляд предмета.
